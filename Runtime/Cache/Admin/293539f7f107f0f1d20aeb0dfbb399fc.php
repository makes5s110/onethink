...
<body>
    ...
    <!--<script type="text/javascript">-->
        <!--$(function() <?php echo --> <!-- <!--$('.list_sort').click(function(){--> <!--var url = $(this).attr('url');--> <!--var ids = $('.ids:checked');--> <!--var param = '';--> <!--if(ids.length > 0){--> <!--var str = new Array();--> <!--ids.each(function(){--> <!--str.push($(this).val());--> <!--;?>);-->
                    <!--param = str.join(',');-->
                <!--}-->

                <!--if(url != undefined && url != '')<?php echo --> <!--window.location.href = url + '/ids/' + param;--> <!--;?>-->
            <!--});-->
        <!--});-->
    <!--</script>-->
