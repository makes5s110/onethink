...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">报修人<span class="check-tips">（必填）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="name" value="<?php echo ((isset($info["name"]) && ($info["name"] !== ""))?($info["name"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">电话号码<span class="check-tips">（必填）</span></label>
			<div class="controls">
		...
		<div class="form-item">
			<label class="item-label">报修问题<span class="check-tips">（必填）</span></label>
			<div class="controls textarea input-large">
				<textarea name="intro" value=""><?php echo ((isset($info["intro"]) && ($info["intro"] !== ""))?($info["intro"]):''); ?></textarea>
			</div>
		</div>
		<div class="form-item">
